...
**Focus of this category.** How do previously published systematic reviews of cancer treatment build the cognition concept in their database search strategies?
...
## Treanor CJ, 2016 - Cochrane Database of Systematic Reviews
...
**Purpose.** To evaluate the cognitive effects, non-cognitive effects, duration and safety of non-pharmacological interventions aimed at maintaining cognitive function or ameliorating cognitive impairment resulting from cancer or systemic cancer treatment. The most complete cognition search block found in this exercise: one core adjacency statement generates the cross-product of nine cognition terms and ten impairment terms, sitting alongside five controlled-vocabulary terms and a chemo-fog/chemo-brain phrase. Reproduced in six database syntaxes, including a native PubMed version.
...
## Lawrie TA, 2019 - Cochrane Database of Systematic Reviews
...
**Purpose.** To evaluate the long-term (at least two years after diagnosis) neurocognitive and other side effects of radiotherapy, with or without chemotherapy, in people with glioma, and to write a brief economic commentary. Included as an exemplar of the alternative structure: rather than a stand-alone cognition block, cognit* is one term inside a generic late-effects adjacency, so cognition is retrieved as a species of treatment harm.
...
## Jim HSL, 2012 - Journal of Clinical Oncology
...
- URL: <https://doi.org/10.1200/JCO.2011.39.5640>
- PMID: 22927526 | PMCID: PMC3462044
- Search strategy taken from: Methods section (Search Strategy), read from PMC3462044

**Purpose.** To quantify cognitive deficits in breast cancer survivors at least six months after completing standard-dose chemotherapy, and to examine demographic and clinical moderators (age, education, time since chemotherapy, endocrine therapy). Included deliberately as the counter-example: a meta-analysis in the highest-impact journal in this collection, whose entire search is seven short keyword pairings with no structured concept blocks, no truncation discipline and no design filter.
