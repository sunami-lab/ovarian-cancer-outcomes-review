...
## Neo J, 2017 - Cancer Treatment Reviews
...
- URL: <https://doi.org/10.1016/j.ctrv.2017.10.006>
- PMID: 29125982
- Search strategy taken from: Online supplement Appendix 1 (Search terms used in review; example MEDLINE strategy), obtained from the King's College London institutional repository copy (gold OA, CC BY-NC-ND) identified via Unpaywall

**Purpose.** To determine the prevalence of disability in activities of daily living among adults with cancer, which ADL items are most often affected, and which instruments are used to measure it. The best functional-status search block available in this impact band: the review has no intervention concept at all, and instead intersects a two-term cancer population with a thirteen-synonym functional-disability block and an observational-design filter. If you take one outcome block for functional status, take this one.
